...
<template>
  <div class="h-100vh flex flex-col" style="background-color: var(--c-bg)">
    <nav
      class="h-48px flex items-center px-6 gap-6 shrink-0"
      style="background-color: var(--c-bg-secondary); border-bottom: 1px solid var(--c-border)"
    >
      <span
        class="font-bold"
        style="font-size: var(--fs-lg); color: var(--c-brand)"
      >
